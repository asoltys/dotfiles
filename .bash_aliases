...
alias arc="docker exec -it archive keydb-cli"
alias db="rlwrap -a -- docker exec -it db keydb-cli"
...
alias ld="docker exec -it lit lncli"
alias lit="docker exec -it lit"
alias lr="cd ~/la"
alias dc="docker compose"
alias dcd="el decoderawtransaction"
alias tx="el gettransaction"
alias ub="el unblindrawtransaction"
alias addr="el getnewaddress | tr -d '\r'"
...
alias rw="cp ~/bin/rw ~/bin/el"
alias lm="cp ~/bin/lm ~/bin/el"
alias dup="docker compose up -d --remove-orphans"
alias down="docker compose down --remove-orphans"
alias inq="cp ~/bin/inq ~/bin/el"
alias simp="cp ~/bin/simp ~/bin/el"
alias simpx="cp ~/bin/simpx ~/bin/el"
alias btc="cp ~/bin/btc ~/bin/el"
alias ex="cp ~/bin/ex ~/bin/el"
alias exl="cp ~/bin/exl ~/bin/el"
alias lq="cp ~/bin/lq ~/bin/el"
alias rar="cp ~/bin/rar ~/bin/el"
alias lqx="cp ~/bin/lqx ~/bin/el"
alias elem="cp ~/bin/elem ~/bin/el"
alias lt="cp ~/bin/lt ~/bin/el"
alias ltc="cp ~/bin/ltc ~/bin/el"
alias nig="cp ~/bin/nig ~/bin/el"
alias gca="git cherry-pick --abort"
alias lg="docker logs -fn 200"
alias qr="docker exec -it postgres psql -U postgres -c"
alias qrr="docker exec -it postgres psql -U raretoshi -c"
...
alias ark2='docker exec -e ARK_WALLET_DATADIR=./ark2 -it arkd ark'
