...
alias la="lncli --lnddir=/root/.lnda --network=mainnet --chain=bitcoin --rpcserver=localhost:10001"
alias lad="/root/gocode/src/github.com/lightningnetwork/lnd/lncli-debug --lnddir=/root/.lnda --network=mainnet --chain=bitcoin --rpcserver=localhost:10001"
alias lb="lncli --lnddir=/root/.lndb --network=mainnet --chain=bitcoin --rpcserver=localhost:10002"
alias lbd="/root/gocode/src/github.com/lightningnetwork/lnd/lncli-debug --lnddir=/root/.lndb --network=mainnet --chain=bitcoin --rpcserver=localhost:10002"
...
alias ecs="elements-cli -rpcwallet=swapserver"
alias er="elements-cli -datadir=$HOME/data/.elements_regtest"
alias er2="elements-cli -datadir=$HOME/data/.elements_regtest2"
alias ers="elements-cli -datadir=$HOME/data/.elements_regtest -rpcwallet=swapserver"
